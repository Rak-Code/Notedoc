...
public class NoteCreateRequestDto {
    ...
    @Schema(description = "Note title", example = "Meeting Notes", required = true, maxLength = 255)
    private String title;
    
    @Schema(description = "Note content in markdown format", example = "## Agenda\n- Discuss project timeline\n- Review budget")
    private String content;
    
    @Schema(description = "Set of tags for categorizing the note", example = "[\"work\", \"meeting\", \"project\"]")
    private Set<String> tags = new HashSet<>();
    
    @Schema(description = "Whether the note is pinned", example = "false", defaultValue = "false")
